...
const IG_TILES = [
  { img: "../../assets/poster-avraham-tal.jpg", caption: "אברהם טל · בחזרה אל שוטי הנבואה" },
  { img: "../../assets/poster-hiluma.jpg",      caption: "תום כהן · היהלום III" },
  { img: "../../assets/poster-pop-icon.jpg",    caption: "פוף אייקון · ואלרי וליראז" },
  { img: "../../assets/poster-itzik-kala.jpg",  caption: "איציק קלה · דיוקן אמן" },
  { img: "../../assets/postcard-season.jpg",    caption: "עונת המנויים 2026/2027" },
  { img: "../../assets/poster-avraham-tal.jpg", caption: "טעימה מאתמול באשקלון" },
];
