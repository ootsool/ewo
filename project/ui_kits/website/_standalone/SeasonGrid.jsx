...
const POSTERS = [
  { id: "shotei",   img: window.__resources.posterAvrahamTal, title: "בחזרה אל \u201cשוטי הנבואה\u201d", artist: "אברהם טל",           date: { d: "14", m: "נוב", y: "2026" }, venue: "היכל התרבות, ת״א" },
  { id: "diyokan",  img: window.__resources.posterItzikKala,  title: "דיוקן אמן / תחנות בזמן",          artist: "איציק קלה",          date: { d: "08", m: "ינו", y: "2027" }, venue: "תיאטרון ירושלים" },
  { id: "popicon",  img: window.__resources.posterPopIcon,    title: "פוף אייקון",                       artist: "ואלרי חמאתי וליראז צ\u2019רדלי", date: { d: "20", m: "מרץ", y: "2027" }, venue: "אולם צ׳ארלס ברונפמן" },
  { id: "hiluma",   img: window.__resources.posterHiluma,     title: "היהלום III",                       artist: "תום כהן",            date: { d: "12", m: "יוני", y: "2027" }, venue: "אוטופיה, גני יהושע" },
];
